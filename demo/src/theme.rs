...
pub const BACKGROUND: Role = Role {
    dark: 0x1e2127,
    light: 0xfafafa,
};
/// Background of a panel, a sidebar, a bar.
pub const PANEL: Role = Role {
    dark: 0x22262d,
    light: 0xf3f3f3,
};
/// Background of a hovered row.
pub const HOVER: Role = Role {
    dark: 0x2c313a,
    light: 0xe8e8e8,
};
/// Background of a selected row.
pub const SELECTED: Role = Role {
    dark: 0x3a4048,
    light: 0xdcdcdc,
};
/// Separator between regions.
pub const BORDER: Role = Role {
    dark: 0x2f343d,
    light: 0xdfdfdf,
};
/// Default foreground.
pub const TEXT: Role = Role {
    dark: 0xc8ccd4,
    light: 0x24292f,
};
/// Foreground for secondary information.
pub const TEXT_MUTED: Role = Role {
    dark: 0x7f8896,
    light: 0x6b7280,
};
/// Accent, for what the eye should land on first.
pub const ACCENT: Role = Role {
    dark: 0x61afef,
    light: 0x0969da,
};
/// Foreground on top of the accent.
pub const ON_ACCENT: Role = Role {
    dark: 0x1e2127,
    light: 0xffffff,
};
/// The colour of a failure.
pub const DANGER: Role = Role {
    dark: 0xe06c75,
    light: 0xcf222e,
};
