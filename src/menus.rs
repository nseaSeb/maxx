    ...
    vec![
            ...
            items: vec![
                MenuItem::submenu(Menu {
                    ...
                    items: vec![
                        ...
                        MenuItem::action(tr("menu.template_list_detail"), NewListDetailProject),
                        MenuItem::action(tr("menu.template_form"), NewFormProject),
                        MenuItem::action(tr("menu.template_dashboard"), NewDashboardProject),
                        MenuItem::action(tr("menu.template_wizard"), NewWizardProject),
                        MenuItem::action(tr("menu.template_utility"), NewUtilityProject),
                        MenuItem::action(tr("menu.template_editor"), NewEditorProject),
                    ],
                }),
                ...
                MenuItem::separator(),
                MenuItem::action(tr("menu.reveal_tab_in_project"), RevealTabInProject),
                MenuItem::action(tr("menu.copy_tab_path"), CopyTabPath),
                MenuItem::separator(),
                MenuItem::action(tr("menu.close_project"), CloseFolder),
                MenuItem::action(tr("menu.close_view"), CloseWindow),
                MenuItem::action(tr("menu.close_other_tabs"), CloseOtherTabs),
                MenuItem::action(tr("menu.close_tabs_to_the_right"), CloseTabsToTheRight),
            ],
        },
        Menu {
            name: tr("menu.edit"),
            items: vec![
                ...
                MenuItem::action(tr("menu.wrap_in_column"), WrapInColumn),
                MenuItem::action(tr("menu.wrap_in_row"), WrapInRow),
                MenuItem::action(tr("menu.unwrap"), Unwrap),
                ...
                MenuItem::action(tr("menu.add_submenu"), AddSubmenu),
                MenuItem::action(tr("menu.delete_menu_entry"), DeleteMenuEntry),
                MenuItem::separator(),
                MenuItem::action(tr("menu.move_up"), MoveMenuUp),
                MenuItem::action(tr("menu.move_down"), MoveMenuDown),
                MenuItem::action(tr("menu.move_node_up"), MoveNodeUp),
                MenuItem::action(tr("menu.move_node_down"), MoveNodeDown),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::separator(),
                MenuItem::action(tr("menu.theme"), ToggleTheme),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::separator(),
                MenuItem::action(tr("menu.open_handler"), OpenHandler),
                MenuItem::separator(),
